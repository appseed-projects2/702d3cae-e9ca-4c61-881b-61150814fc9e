...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-08 10:22`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/702d3cae-e9ca-4c61-881b-61150814fc9e.git
$ cd 702d3cae-e9ca-4c61-881b-61150814fc9e
```
